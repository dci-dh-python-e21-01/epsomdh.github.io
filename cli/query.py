...
if args.user_name: #if I  put --user name when I start the program , it takes the name from the argument
...
#checking if we have enough items
           if item_number <= (elm_count_1 + elm_count_2):#if yes
             print("An order of",(elm_count_1 + elm_count_2),item_name,"has been placed")#make order
           else:#if not
            print("There are not this many items available.The maximum amount that can be ordered is ",(elm_count_1 + elm_count_2))#say we don't have that many items
            ...
            if max_order==1:#if yes
              print("An order of",(elm_count_1 + elm_count_2),item_name,"has been placed")#print that order is placed
